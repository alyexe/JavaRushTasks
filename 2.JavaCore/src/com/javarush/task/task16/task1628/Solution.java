...
public class Solution {
    ...
    public static class ReaderThread extends Thread {
        ...
        public void run() {
            ...
            try {
                while (!isInterrupted()) {
                    synchronized (reader) { //нагло стырено с https://ru.stackoverflow.com/questions/732637/java-Как-правильно-использовать-bufferedreader-одновременно-несколькими-потока/732784#732784
                        if (reader.ready()) {
